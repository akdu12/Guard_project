...
import 'package:guard/ui/screens/home.dart';
...
class _registerState extends State<register> {
  ...
  void signUp(String email, String password) async {
    print("objectobject email : ${email}");
    print("objectobject password : ${password}");
    ...
    if (_formKey.currentState!.validate()) {
      await _auth
          ...
          .catchError((e) {
        print("objectobject password : ${e.toString()}");
      });
    }
  }
  ...
  postDetailsToFirestore() {
    ...
    firestore.collection("users").add(user.toJson()).then((value) {
      print(value.id);
