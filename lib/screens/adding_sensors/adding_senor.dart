            ...
            children: [
                 ...
                 Column(
                   children: [
                     RadioListTile<Sensors>(
                        ...
                        title: Text('Air Quality', style: TextStyle(fontWeight: FontWeight.w800),),
                        subtitle: Text(
              ...
              if (newUser!.sensors![1].location == '') ...[
                Column(
                  children: [
                    RadioListTile<Sensors>(
                      title: Text('Motion', style: TextStyle(fontWeight: FontWeight.w800),),
                      subtitle: Text(
              ...
              if (newUser!.sensors![2].location == '') ...[
                Column(
                  children: [
                    RadioListTile<Sensors>(
                      title: Text('Spectrum', style: TextStyle(fontWeight: FontWeight.w800),),
                      subtitle: Text(
              ...
              if (newUser!.sensors![3].location == '') ...[
                Column(
                  children: [
                    RadioListTile<Sensors>(
                      title: Text('Color and Luminance', style: TextStyle(fontWeight: FontWeight.w800),),
                      subtitle: Text(
              ...
              if(newUser!.sensors!.any((element) => element.location == '')) ...[
                Padding(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            if (_sensors == Sensors.AirQuality) {
                              try {
                                if (newUser!.sensors![0].location!.isEmpty) {
                                  ...
                                  print("Abc");
                                  final snackBar = SnackBar(
                                    content: Text("Sensor already exists"),
                              ...
                              try {
                                if (newUser!.sensors![1].location!.isEmpty) {
                                  ...
                                  final snackBar = SnackBar(
                                    content: Text("Sensor already created"),
                                    backgroundColor: Colors.red,
                                  );
                                  ScaffoldMessenger.of(context)
                                      .showSnackBar(snackBar);
                              ...
                              try {
                                if (newUser!.sensors![2].location!.isEmpty) {
                            ...
                            } else if (_sensors == Sensors.ColorAndLuminance) {
                              try {
                                if (newUser!.sensors![3].location!.isEmpty) {
                                  ...
                                  final snackBar = SnackBar(
                                    content: Text("Sensors already created"),
                                    backgroundColor: Colors.red,
                                  );
                                  ScaffoldMessenger.of(context)
                                      .showSnackBar(snackBar);
