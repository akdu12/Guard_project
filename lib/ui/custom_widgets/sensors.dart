      ...
      children: [
        Container(
          ...
          child: isDataLoad
              ...
              Center(
                child: Text("Add sensor to monitor your home"),
              ) :
          ListView.builder(
                    ...
                    return  Visibility(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            //             // status: newUser!.sensors![index].status as bool,
                            //             id: newUser!.sensors![iindex].id
                            //                 .toString(),
                            //             location: newUser!
                            //                 .sensors![iindex].location
                            //                 .toString(),
                            //             name: newUser!.sensors![iindex].name
                            //                 .toString(),
                            //             description: newUser!
                            //                 .sensors![iindex].description
                            //                 .toString(),
                            //             image: newUser!.sensors![iindex].imgUrl
                            //                 .toString(),
                            //           )),
                            // );
                            var loc =
